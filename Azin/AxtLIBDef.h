...
#define AXT_FMNSH4D						0x52				// ISA bus, Full size, DB-32T, SIO-2V03 * 2
#define AXT_BPHD						0x83				// PCI bus, Half size, DB-32T
...
#define AXT_SIO_CN2CH					0xA8				// SIO-CN2CH: Counter 2CH
...
typedef void (*AXT_CAMCIP_INTERRUPT_PROC)(INT16 nBoardNo, INT16 nModulePos, UINT8 byFlag);
