...
void CDlgIPGDualLaser::HEAD1classification()
{
	...
	for (unsigned int i = 0; i < binaryStatus.size(); i++) 
	{
		...
		{	
			...
			case 2: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_Emission_modulation; break;//modulation on/off
			case 3: i=32;
			default: continue;
		...
		{
			case 0:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD1_controlId); p->SetChecked(TRUE);break;}
			case 1:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD1_controlId);p->SetChecked(FALSE);break;}
	...
	for (unsigned int i = 0; i < binaryHEAD1Status.size(); i++) 
	{
		...
		case 1: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_POWER_SUPPLY; break;//main power supply is on
		case 2: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_LAER_READY; break;//LASER_READY
		case 3: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_EMISSION; break;//EMISSION
		case 4: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_GUIDE_LASER; break;//GUIDE_LASER
			if(m_strSiteName == "SDI")
			{
		case 5: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_UNEXPECTED_INTERUPTION_OF_EMISSION; break;//UNEXPECTED_INTERUPTION_OF_EMISSION
			} else
			{
		case 7: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_UNEXPECTED_INTERUPTION_OF_EMISSION; break;//UNEXPECTED_INTERUPTION_OF_EMISSION
			}
		...
		{
		case 1:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD1_controlId); p->SetChecked(TRUE);break;}
		case 0:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD1_controlId);p->SetChecked(FALSE);break;}
	...
	for (unsigned int i = 0; i < binaryHEAD1EXSTATUS.size(); ++i) 
	{
		...
		switch (i) 
		{
		case 0: HEAD1_controlId = IDC_CTCHECK_HEAD1_STATUS_HK_PS_HOT_STOP; break;//HK_PS_HOT_STOP
	...
	for (unsigned int i = 0; i < binaryHEAD1WARINGS.size(); ++i)
	{
		switch (i) 
		{
		case 0: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_PRR_LOW; break;//PRR_LOW
		case 1: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_PRR_HIGH; break;//PRR_HIGH
		case 5: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_LASER_TEMERATURE_TOO_LOW; break;//LASER_TEMERATURE_TOO_LOW
		case 6: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_LASER_TEMERATURE_TOO_HIGH; break;//_LASER_TEMERATURE_TOO_HIGH
		case 9: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_WORNG_MODE; break;//WORNG_MODE
			//case 10: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_GUIDE_LASER; break;//DEW_POINT
			if(m_strSiteName == "SDI")
			{
		case 11: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_GUIDE_LASER; break;//GUIDE_LASER_WARNING
		case 12: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_FANSPEED; break;//FABN_SPEED
			}
	...
	for (unsigned int i = 0; i < binaryEXAlARMS.size(); i++) 
	{
		switch (i) 
		{
			if(m_strSiteName == "SDI")
			{
		case 0: HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_HK_POWER_SUPPLY_TOO_LOW; break;//HK_POWER_SUPPLY_TOO_LOW
		case 1: HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_HK_POWER_SUPPLY_TOO_HIGH; break;//HK_POWER_SUPPLY_TOO_HIGH
			}

		case 4: HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_LASER_TEMPERATURE_TOO_LOW; break;//LASER_TEMERATURE_TOO_LOW
		case 5: HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_LASER_TEMPERATURE_TOO_HIGH; break;//_LASER_TEMERATURE_TOO_HIGH
		case 10: HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_MAIN_POWER_SUPPLY_TOO_HIGH; break;//MAIN_POWER_SUPPLY_TOO_HIGH
			//case 10: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_GUIDE_LASER; break;//DEW_POINT
		case 11: i=32;
		default: continue;
	...
	for (unsigned int i = 0; i < binaryHEAD1Alarms.size(); i++) 
	{
		...
		case 3: 
			HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_VOLATGE; break;//voltage_alarm
		case 4: 
			HEAD1_controlId = IDC_CTCHECK_HEAD1_BACK_REFLECTION; break;//back_reflection_alarm
			//case 5: HEAD1_controlId = IDC_CTCHECK_HEAD1_WARNINGS_WORNG_MODE; break;//feeding_fiber_alarm
			if(m_strSiteName == "SDI")
			{
		case 6: HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_SAFTY; break;//safety_alarm
		case 7: HEAD1_controlId = IDC_CTCHECK_HEAD1_ALARM_GUIDE_LASER; break;//GUIDE_LASER
			}
		case 9: i=32;
		default: continue;
		...
		case 1:{
			bErrorFlag = TRUE;
			CctCheck* p = (CctCheck*)GetDlgItem(HEAD1_controlId); p->SetChecked(TRUE);
			break;
			   }
		case 0:
			{
				CctCheck* p = (CctCheck*)GetDlgItem(HEAD1_controlId);p->SetChecked(FALSE);
...
void CDlgIPGDualLaser::HEAD2classification()
{
	...
	for (unsigned int i = 0; i < binaryHEAD2InstalledStatus.size(); i++) 
	{
		...
		{	
			...
			case 2: HEAD2_controlId = IDC_CTCHECK_HEAD2_STATUS_Emission_modulation; break;//modulation on/off
			case 3: i=32;
			default: continue;
		...
		{
			case 0:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId); p->SetChecked(TRUE);break;}
			case 1:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId);p->SetChecked(FALSE);break;}
	...
	for (unsigned int i = 0; i < binaryHEAD2Status.size(); i++) 
	{
        ...
        case 1: HEAD2_controlId = IDC_CTCHECK_HEAD2_STATUS_POWER_SUPPLY; break;//main power supply is on
        case 2: HEAD2_controlId = IDC_CTCHECK_HEAD2_STATUS_LASER_READY; break;//LASER_READY
        case 3: HEAD2_controlId = IDC_CTCHECK_HEAD2_STATUS_EMISSION; break;//EMISSION
        case 4: HEAD2_controlId = IDC_CTCHECK_HEAD2_STATUS_GUIDE_LASER; break;//GUIDE_LASER
        case 5: HEAD2_controlId = IDC_CTCHECK_HEAD2_STATUS_UNEXPECTED_INTERUPTION_OF_EMISSION; break;//UNEXPECTED_INTERUPTION_OF_EMISSION
		...
		{
			case 1:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId); p->SetChecked(TRUE);break;}
			case 0:{CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId);p->SetChecked(FALSE);break;}
			//default: {CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId);p->SetChecked(FALSE);break;}
		}
	...
	for (unsigned int i = 0; i < binaryHEAD2EXSTATUS.size(); ++i) 
	{
		...
		switch (i) 
		{
			case 0: HEAD2_controlId = IDC_CTCHECK_HEAD2_STATUS_HK_PS_HOT_STOP; break;//HK_PS_HOT_STOP
	...
	{
		switch (i) {
		case 0: HEAD2_controlId = IDC_CTCHECK_HEAD2_WARNINGS_PRR_LOW; break;//PRR_LOW
        case 1: HEAD2_controlId = IDC_CTCHECK_HEAD2_WARNINGS_PRR_HIGH; break;//PRR_HIGH
        case 5: HEAD2_controlId = IDC_CTCHECK_HEAD2_WARNINGS_LASER_TEMPERATURE_TOO_LOW; break;//LASER_TEMERATURE_TOO_LOW
        case 6: HEAD2_controlId = IDC_CTCHECK_HEAD2_WARNINGS_LASER_TEMPERATURE_TOO_HIGH; break;//_LASER_TEMERATURE_TOO_HIGH
	...
	{
		switch (i) {
			case 0: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_HK_POWER_SUPPLY_TOO_LOW; break;//HK_POWER_SUPPLY_TOO_LOW
			case 1: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_HK_POWER_SUPPLY_TOO_HIGH; break;//HK_POWER_SUPPLY_TOO_HIGH
			case 4: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_LASER_TEMPERATURE_TOO_LOW; break;//LASER_TEMERATURE_TOO_LOW
			case 5: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_LASER_TEMPERATURE_TOO_HIGH; break;//_LASER_TEMERATURE_TOO_HIGH
			case 10: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_MAIN_POWER_SUPPLY_TOO_HIGH; break;//MAIN_POWER_SUPPLY_TOO_HIGH
	...
	for (unsigned int i = 0; i < binaryHEAD2Alarms.size(); i++) 
	{
		...
		case 1: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_CRITICAL_ALARM;
			break;//critical
		case 2: 
			{
		...
		case 3: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_VOLATGE; break;//voltage_alarm
		case 4: HEAD2_controlId = IDC_CTCHECK_HEAD2_BACK_REFLECTION; break;//back_reflection_alarm
		//case 5: HEAD2_controlId = IDC_CTCHECK_HEAD2_WARNINGS_WORNG_MODE; break;//feeding_fiber_alarm
		case 6: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_SAFTY; break;//safety_alarm
		case 7: HEAD2_controlId = IDC_CTCHECK_HEAD2_ALARM_GUIDE_LASER; break;//GUIDE_LASER
		case 9: i=32;
		default: continue;
		}
		...
		case 1:{
				bErrorFlag = TRUE;
				CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId); p->SetChecked(TRUE);
				break;
			   }
		case 0:
			{
				pDsp->nOutputIO(RTC_CARD_NUM_2, RTC_SIG_O_ALARM, FALSE);
				CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId);p->SetChecked(FALSE);
				break;
			}
			//default: {CctCheck* p = (CctCheck*)GetDlgItem(HEAD2_controlId);p->SetChecked(FALSE);break;}
		}
...
void CDlgIPGDualLaser::LedOnOff(UINT uid,int flag)
{
	...
	switch (flag)
	{
		case LED_GRAY: plcon->SetBitmap(m_mLedGray);break;
		case LED_GREEN_ON: plcon->SetBitmap(m_mLedGreen);break;
	}
}
...
float CDlgIPGDualLaser::byteArrayToFloat32(const BYTE* byteArr)
{
    ...
    converter.intValue = static_cast<UINT32>(byteArr[0])
                      | (static_cast<UINT32>(byteArr[1]) << 8)
                      | (static_cast<UINT32>(byteArr[2]) << 16)
                      | (static_cast<UINT32>(byteArr[3]) << 24);
...
/*void CDlgIPGDualLaser::OnBtnFreqSet() //굳이 써야되?
{
...
void CDlgIPGDualLaser::OnBtnPwrSet() 
{
