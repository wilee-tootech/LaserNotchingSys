...
BEGIN_MESSAGE_MAP(CFileTreeCtrl2, CTreeCtrl)
	//{{AFX_MSG_MAP(CFileTreeCtrl2)
...
/////////////////////////////////////////////////////////////////////////////
// CFileTreeCtrl2 message handlers

int CFileTreeCtrl2::SetImageList()
{
...
int CFileTreeCtrl2::InitDriveCtrl()
{
	int nPos=0;
	int nDrives = 0;
	CString strDrive = "?:\\";
...
BOOL CFileTreeCtrl2::AddDriveNode(CString &strDrive)
{
	CString str;
	HTREEITEM hItem;
...
BOOL CFileTreeCtrl2::SetButtonState(HTREEITEM hItem, CString strPath)
{
	if(strPath.Right(1) != "\\")
		strPath += "\\";
	strPath += "*.*";
...
/////////////////////////////////////////////////////////////////
// 노드가 확장 하거나 축소 할 때 
void CFileTreeCtrl2::OnItemexpanding(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
///////////////////////////////////////////////////////////////////
// 노드 확장, 축소 후 호출 된다
void CFileTreeCtrl2::OnItemexpanded(NMHDR* pNMHDR, LRESULT* pResult) 
{
	NM_TREEVIEW* pNMTreeView = (NM_TREEVIEW*)pNMHDR;
	// TODO: Add your control notification handler code here
...
///////////////////////////////////////////////////////
// 핸재 핸들의 Path를 구한다
CString CFileTreeCtrl2::GetPathFromNode(HTREEITEM hItem)
{
...
void CFileTreeCtrl2::DeleteFirstChild(HTREEITEM hParent)
{
	HTREEITEM hItem;
...
////////////////////////////////////////////////
// 모든 자식 노드를 제거한다
void CFileTreeCtrl2::DeleteAllChildren(HTREEITEM hParent)
{
	HTREEITEM hItem;
	if((hItem = GetChildItem(hParent)) == NULL)
		return;
...
int CFileTreeCtrl2::AddDir(HTREEITEM hItem, CString &strPath)
{
	CString strFindPath;
	HTREEITEM hNewItem;
	int nCount = 0;
	...
	SortChildren(hItem); // 2003.07.10 Sorting 위해서 추가
...
BOOL CFileTreeCtrl2::SetFilePathTree(CString filepath)
{
	HTREEITEM hItem, parentItem=NULL;// 2003.07.10 Sorting 위해서 추가 //, tempItem;
	hItem = GetRootItem();
	...
	{	
		...
		do
		{
			...
			{
				SelectItem(hItem);
				parentItem = hItem; // 2003.07.10 Sorting 위해서 추가
				Expand(hItem, TVE_EXPAND);
	...
	SortChildren(parentItem); // 2003.07.10 Sorting 위해서 추가
//	if (success == TRUE)
//		SelectItem(hItem);
	return success;
}
...
CString CFileTreeCtrl2::GetNextNameFromPath(CString& path)
{
	int index;
	CString result;
...
void CFileTreeCtrl2::OnSelchanged(NMHDR* pNMHDR, LRESULT* pResult) 
{
	NM_TREEVIEW* pNMTreeView = (NM_TREEVIEW*)pNMHDR;
	// TODO: Add your control notification handler code here
