...
void CctList::SetFont(LPFONTDISP propVal)
{
...
LPDISPATCH CctList::GetTitleFont()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetTitleBackImage()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetHeaderFont()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetSubTextFont()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetTipsFont()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetCheckPicDown()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetCheckPicUp()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetBackImage()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetCheckPicDisabled()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetPrintTitleFont()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetMouseIcon()
{
	LPDISPATCH result;
...
LPDISPATCH CctList::GetPreColumnPicture()
{
	LPDISPATCH result;
...
short CctList::CalcSubTextHeight(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x94, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CctList::GetColumnWidth(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xa1, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CctList::GetColumnTextAlign(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xa2, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CctList::GetColumnPicture(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xa3, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
BOOL CctList::GetColumnLock(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xa5, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, parms,
		nIndex);
	return result;
}
...
CString CctList::GetListText(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xa7, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, parms,
		nIndex);
	return result;
}
...
unsigned long CctList::GetListForeColor(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xa9, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		nIndex);
	return result;
}
...
unsigned long CctList::GetColumnBackColor(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xaa, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		nIndex);
	return result;
}
...
unsigned long CctList::GetColumnForeColor(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xac, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		nIndex);
	return result;
}
...
CString CctList::GetListSubText(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xad, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CctList::GetListSubHeight(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xaf, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
CString CctList::GetCellText(long nIndex, short nColumn)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2;
	InvokeHelper(0xb0, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, parms,
		nIndex, nColumn);
	return result;
}
...
short CctList::GetCellPicture(long nIndex, short nColumn)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2;
	InvokeHelper(0xb1, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex, nColumn);
	return result;
}
...
short CctList::GetColumnPictureAlign(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xb2, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CctList::GetColumnCheckAlign(short nIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xb3, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CctList::GetCellCheck(long nIndex, short nColumn)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2;
	InvokeHelper(0xb4, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex, nColumn);
	return result;
}
...
short CctList::GetCellPicSelect(long nIndex, short nColumn)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2;
	InvokeHelper(0xb5, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex, nColumn);
	return result;
}
...
BOOL CctList::GetListSelect(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xb7, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CctList::GetListIndent(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xb8, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		nIndex);
	return result;
}
...
LPDISPATCH CctList::GetListImage(short nIndex)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xba, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms,
		nIndex);
	return result;
}
...
BOOL CctList::GetListHeader(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xbb, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, parms,
		nIndex);
	return result;
}
