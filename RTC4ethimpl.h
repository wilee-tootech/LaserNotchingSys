...
//-----------------------------------------------------------------------------
//
//  Copyright (c) 2015 SCANLAB AG
//
//  Abstract
//      RTC4eth function prototypes for implicitly linking - also known as
//      static load linking - to the RTC4ethDLL.DLL.
//
//  Author
//      Gerald Schmid
//
...
//      import library RTC4ethDLL.LIB.
//
//-----------------------------------------------------------------------------

_declspec(dllimport) unsigned long __stdcall acquire_rtc(unsigned long ip);
_declspec(dllimport) unsigned long __stdcall release_rtc(unsigned long ip);
_declspec(dllimport) unsigned long __stdcall convert_string_to_ip(const char* ip);
_declspec(dllimport) void __stdcall convert_ip_to_string(unsigned long ip, const char* cpip);
_declspec(dllimport) void __stdcall convert_mac_to_string(int64_t mac, const char* cpmac);
_declspec(dllimport) unsigned long __stdcall rtc_search_cards(unsigned short *cards, unsigned long ip, unsigned long netmask);
_declspec(dllimport) int64_t __stdcall get_mac_address(unsigned short cardno);
_declspec(dllimport) unsigned long __stdcall get_ip_address(unsigned short cardno);
_declspec(dllimport) unsigned long __stdcall get_serial(unsigned short cardno);
_declspec(dllimport) unsigned short __stdcall get_connection_status(unsigned short cardno);
_declspec(dllimport) unsigned long __stdcall get_master_ip_address(unsigned short cardno);
_declspec(dllimport) unsigned long __stdcall get_master_id(unsigned short cardno, const char* id);
_declspec(dllimport) void __stdcall set_timeout(unsigned long timeout);
_declspec(dllimport) unsigned long __stdcall set_static_ip(unsigned long ip, unsigned long netmask);
_declspec(dllimport) unsigned long __stdcall get_static_ip(unsigned long *ip, unsigned long *netmask);
_declspec(dllimport) unsigned long __stdcall get_mcu_fw_version(unsigned short cardno);
_declspec(dllimport) unsigned long __stdcall get_nic_ip_count(unsigned short *count);
_declspec(dllimport) void __stdcall get_nic_ip(unsigned short count, unsigned long *ip, unsigned long *nm);
_declspec(dllimport) void __stdcall n_get_waveform(unsigned short n, unsigned short channel, unsigned short istop, signed short *memptr);
_declspec(dllimport) void __stdcall get_waveform(unsigned short channel, unsigned short istop, signed short *memptr);
...
_declspec(dllimport) void __stdcall n_set_list_jump(unsigned short n, unsigned short position);
_declspec(dllimport) void __stdcall set_list_jump(unsigned short position);
_declspec(dllimport) void __stdcall n_set_input_pointer(unsigned short n, unsigned short pointer);
_declspec(dllimport) void __stdcall set_input_pointer(unsigned short pointer);
_declspec(dllimport) void __stdcall n_list_call(unsigned short n, unsigned short position);
_declspec(dllimport) void __stdcall list_call(unsigned short position);
...
_declspec(dllimport) void __stdcall n_set_pixel(unsigned short n, unsigned short pulswidth, unsigned short davalue, unsigned short adchannel);
_declspec(dllimport) void __stdcall set_pixel(unsigned short pulswidth, unsigned short davalue, unsigned short adchannel);
_declspec(dllimport) void __stdcall n_set_extstartpos_list(unsigned short n, unsigned short position);
_declspec(dllimport) void __stdcall set_extstartpos_list(unsigned short position);
...
_declspec(dllimport) void __stdcall n_list_jump_cond(unsigned short n, unsigned short mask_1, unsigned short mask_0, unsigned short position);
_declspec(dllimport) void __stdcall list_jump_cond(unsigned short mask_1, unsigned short mask_0, unsigned short position);
_declspec(dllimport) void __stdcall n_list_call_cond(unsigned short n, unsigned short mask_1, unsigned short mask_0, unsigned short position);
_declspec(dllimport) void __stdcall list_call_cond(unsigned short mask_1, unsigned short mask_0, unsigned short position);
...
_declspec(dllimport) void __stdcall set_trigger(unsigned short sampleperiod, unsigned short signal1, unsigned short signal2);
...
_declspec(dllimport) long __stdcall n_eth_status(unsigned short n);
_declspec(dllimport) long __stdcall eth_status(void);
_declspec(dllimport) unsigned short __stdcall n_get_input_pointer(unsigned short n);
_declspec(dllimport) unsigned short __stdcall get_input_pointer(void);
_declspec(dllimport) void __stdcall select_rtc(unsigned short cardno);
_declspec(dllimport) unsigned short __stdcall rtc4_count_cards(void);
_declspec(dllimport) void __stdcall n_get_status(unsigned short n, unsigned short *busy, unsigned short *position);
_declspec(dllimport) void __stdcall get_status(unsigned short *busy, unsigned short *position);
...
_declspec(dllimport) void __stdcall n_auto_change_pos(unsigned short n, unsigned short start);
_declspec(dllimport) void __stdcall auto_change_pos(unsigned short start);
...
_declspec(dllimport) void __stdcall n_set_list_mode(unsigned short n, unsigned short mode);
_declspec(dllimport) void __stdcall set_list_mode(unsigned short mode);
...
_declspec(dllimport) void __stdcall n_execute_at_pointer(unsigned short n, unsigned short position);
_declspec(dllimport) void __stdcall execute_at_pointer(unsigned short position);
...
_declspec(dllimport) void __stdcall n_set_hi(unsigned short n, double galvogainx, double galvogainy, short galvooffsetx, short galvooffsety, short head);
_declspec(dllimport) void __stdcall set_hi(double galvogainx, double galvogainy, short galvooffsetx, short galvooffsety, short head);
...
_declspec(dllimport) unsigned short __stdcall n_read_pixel_ad(unsigned short n, unsigned short pos);
_declspec(dllimport) unsigned short __stdcall read_pixel_ad(unsigned short pos);
...
_declspec(dllimport) void __stdcall set_softstart_mode(unsigned short mode, unsigned short number, unsigned short resetdelay);
...
_declspec(dllimport) void __stdcall get_hi_data(unsigned short *x1, unsigned short *x2, unsigned short *y1, unsigned short *y2);
_declspec(dllimport) short __stdcall n_auto_cal(unsigned short n, unsigned short head, unsigned short command);
_declspec(dllimport) short __stdcall auto_cal(unsigned short head, unsigned short command);
_declspec(dllimport) unsigned short __stdcall n_get_list_space(unsigned short n);
_declspec(dllimport) unsigned short __stdcall get_list_space(void);
_declspec(dllimport) short __stdcall teachin(const char* filename, short xin, short yin, short zin, double ll0, short *xout, short *yout, short *zout);
...
_declspec(dllimport) void __stdcall n_move_to(unsigned short n, unsigned short position);
_declspec(dllimport) void __stdcall move_to(unsigned short position);
