...
DWORD WINAPI CRunMgr::ExecutePatternSDI_Pouch_Head1(LPVOID lparam)
{
	...
	////////////////////////////////////////////// 2ndJumpPos Start ////////////////////////////////////////////////////////////
	//n_write_io_port_list(RTC_CARD_NUM_1, 65); // 1
	u2ndJumpPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1);
	...
	double dPatternShiftLength = HEAD1ScannerParameter.dPatternShift;
	 
	double* dAccOffset = &stPocketData.dNotchingAccWidth1;
	double* dAccOffset2 = &stPocketData.dNotchingAccOffset1;
	...
	pDsp->WaitForEncoderHEAD1((pDlg->m_nEncoderSumCount - (int)mathUtil.Round(dAccOffset[0] * dNotchingKX, 0)), 1);
	...
	//pDsp->N_Mark_Rel(RTC_CARD_NUM_1, 1, 0, MM); // Laser On Trigger
	...
	nNexSumCount += stPocketData.dArcInYPos + HEAD1ScannerParameter.dCuttingOffset;
	...
	for(int i = 0; i < nFlagCount; i++)
	{
		...
		else
		{
			...
			pDlg->m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
			pDsp->nIf_Cond(RTC_CARD_NUM_1, 0x08, 0x40);
			pDsp->WaitForEncoderHEAD1((pDlg->m_nEncoderSumCount - (int)mathUtil.Round(dAccOffset[i + 1] * dNotchingKX, 0)), 1); // 임시

			pDsp->nIf_Cond(RTC_CARD_NUM_1, 0x48, 0);
			pDsp->WaitForEncoderHEAD1((pDlg->m_nEncoderSumCount - (int)mathUtil.Round(dAccOffset2[i + 1] * dNotchingKX, 0)), 1); // 임시 
	...
	nNexSumCount = 0;
	////////////////////////////////////////////// 2ndJumpPos End //////////////////////////////////////////////////////////////
	nNexSumCount += (dNotchingWidth[0] + dSensorLeng - stPocketData.dArcInYPos - dAccOffset[0] + dPatternShiftLength); // 센서길이를 while문에서 기다렷다고 생각 // test
	...
	for(int i = 0; i < nFlagCount; i++)
	{
		...
		{
			nNexSumCount += (dNotchingWidth[i+1] - stPocketData.dArcOutXPos - dAccOffset[i + 1]);
			if( i == 0 ) 
			{
				nNexSumCount += dEncoderOffset;
			}
...
return 0;
	...
	nNexSumCount = 0;
	////////////////////////////////////////////// 2ndJumpPos End //////////////////////////////////////////////////////////////
	nNexSumCount += (dNotchingWidth[0] + dSensorLeng - stPocketData.dArcInYPos - dAccOffset[0]); // 센서길이를 while문에서 기다렷다고 생각 // test
