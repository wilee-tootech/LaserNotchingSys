...
CRunMgr::CRunMgr(void)
{
	...
	m_hHEAD2Thread = NULL;
	IniUtil _iniutil;
	_iniutil.LoadRealWidthIni(m_PLCTotalLength);
	m_bListCheck = TRUE;
}
...
//BOOL __stdcall CRunMgr::ExecutePatternSDI_Pouch_Head1()
//{
//	static BOOL bRun = FALSE;
...
//	//CInformationView *pDlg = (CInformationView*)lparam;
//	CWriteLog *log= NULL;
...
//	int nTabIndexSetCount = m_stNotchPatternData.dCuttingCnt1;
//	m_iEncoderPos=0;
//
//	// Get PocketPattern Data 250110 MJY
//
...
//	{
//		stPocketData = pFieldParameter->GetPocketPatternAnodeDataModeA();
//	}
//	else if (ModeValue == _T("Anode_B"))
//	{
//		stPocketData = pFieldParameter->GetPocketPatternAnodeDataModeB();
//	}
//	else if (ModeValue == _T("Cathode_A"))
//	{
//		stPocketData = pFieldParameter->GetPocketPatternCathodeDataModeA();
//	}
//	else if (ModeValue == _T("Cathode_B"))
//	{
//		stPocketData = pFieldParameter->GetPocketPatternCathodeDataModeB();
//	}
//
//#ifdef _SIMUL_
//	return 0;
...
//	//GetDlgItemText(IDC_OFFSET3,strTemp);
...
//
//	dNonflagStartWidth = m_stNotchPatternData.dNonflagStartWidth;
//	dNonflagStartHeight = m_stNotchPatternData.dNonflagStartHeight;
//	dNublessRegion = m_stNotchPatternData.dNublessRegion;
//	dNublessHeight = m_stNotchPatternData.dNublessHeight;
//	dNotchRoot = m_stNotchPatternData.dNotchRoot;
//	dTabWidth = m_stNotchPatternData.dTabWidth;
//	dTabCount = m_stNotchPatternData.dTabCount;
//	dTabHeight = stPocketData.dCuttingHeight + stPocketData.dCuttingOffset;
//	dBuriedRegion = m_stNotchPatternData.dBuriedRegion; 
//	dBuriedHeight = m_stNotchPatternData.dBuriedHeight;
//	dNonflagEndWidth = m_stNotchPatternData.dNonflagEndWidth;
//	dNonflagEndHeight = m_stNotchPatternData.dNonflagEndHeight;
//	dTabAngle = m_stNotchPatternData.dTabAngle;
//	dFoilExtention = m_stNotchPatternData.dFoilExtention;
//	dHEAD1Width = m_stNotchPatternData.dHEAD2Width;
//	dTotalWidth = dHEAD1Width + dFoilExtention;
//	dFlagStartWidth = m_stNotchPatternData.dFlagStartWidth;
//	dChangeOffset = pFieldParameter->GetCycleOffset();
//
//
...
//	dBuriedHeight = dBuriedHeight - dHEAD1Width;
//	dNonflagEndHeight = dNonflagEndHeight - dHEAD1Width;
//
//	double dNonflagStartWidthField, dNonflagStartHeightField, dNonflagEndWidthField, dNonflagEndHeightField;
...
//
//	dNonflagStartWidthField = dNonflagStartWidth * m_dMaxField / m_dMaxMM;
...
//
//	double dStartTabWidth = m_stNotchPatternData.dFlagVariableStartLength;
//	double dFinalTabWidth = m_stNotchPatternData.dFlagVariableEndLength;
//	double dTotalLength = m_stNotchPatternData.dFlagVariableTotalLength;
...
//
//
//	m_stNotchPatternData.bYFlip = TRUE;
//	if(m_stNotchPatternData.bYFlip)
...
//
//	dTotalLength = m_stNotchPatternData.dFlagVariableTotalLength;
//
//	uStartPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1);//get_input_pointer();
//
...
//
//	UINT uSecondJumpPos;
//	uSecondJumpPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1); // 이어작업시 - io 변동 없을 시 일로 점프
//
//	CString strHEAD1Encoder;
//	//GetDlgItemText(IDC_SAVED_HEAD1ENC, strHEAD1Encoder);
//
//	double HEAD1TmpEncY;
//	if(_ttoi(strHEAD1Encoder) > 0 )
//	{
//		HEAD1TmpEncY = atof(strHEAD1Encoder) * -pFieldParameter->GetKX(); // 스톱 누르기 전 기존 엔코더값
//		if(HEAD1TmpEncY > stPocketData.dNotchingWidth2) // 플래그 하나보다 기존 엔코더값이 길다면
//		{
//
//		}
//	}
...
//	//pDsp->N_Mark_Rel(RTC_CARD_NUM_1, dTabAngleX, 0); 
//	//pDsp->N_Mark_Rel(RTC_CARD_NUM_1, 0, -(dTabHeightField + dStartExtLenField - (stPocketData.dArcOutXPos * dFieldSize / dMmSize)));
//	pDsp->N_Mark_Abs(RTC_CARD_NUM_1, 0, 0);
//
...
//
//	pDsp->nListJumpRel(RTC_CARD_NUM_1, 11); // 상대적으로 아래 n번째꺼 실행
//	////////////////////////////////////////////// 2ndJumpPos Start ////////////////////////////////////////////////////////////
//
//	n_write_io_port_list(RTC_CARD_NUM_1, 69); // 1
//	u2ndJumpPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1);
//
//	//2025.02.17 jjsjong 향후 센서위치 바꾸거나, UMAC에서 조정후 아래적용예정
//	//pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  3 , 0xFFFC); // IO 들어오는지 모름 - TEST( LaserOn, FirstTab )
//	//pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행
//
//	//pDsp->N_Fly_Return(RTC_CARD_NUM_1, 0, 0, MM);
//
//	pDsp->SetFlyYHEAD1(1.0); 
//	pDsp->SetFlyYHEAD1(0.0);
//	pDsp->SetFlyXHEAD1(1.0);
...
//
//	//pDsp->N_Fly_Return(RTC_CARD_NUM_1, 0, 0, MM);
//	//pDsp->N_Jump_Rel(RTC_CARD_NUM_1, -dEncoderOffset2, 0, MM);
//	/*pDsp->N_Mark_Rel(RTC_CARD_NUM_1, dEncoderOffset2, 0, MM);
//
//	pDsp->N_Fly_Return(RTC_CARD_NUM_1, 0, 0, MM);*/
//	//pDsp->N_Mark_Abs(RTC_CARD_NUM_1, dEncoderOffset2, 0, MM);
//	pDsp->N_Fly_Return(RTC_CARD_NUM_1, 0, 0, MM);
//	pDsp->N_Mark_Abs(RTC_CARD_NUM_1, 0, 0, MM);
//
//	nNexSumCount = 0;
//	////////////////////////////////////////////// 2ndJumpPos End //////////////////////////////////////////////////////////////
//	nNexSumCount += (stPocketData.dNotchingWidth1 - stPocketData.dArcInYPos );
//
//
//	// 들어와서 레이저 안쏨
//	m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
//	pDsp->WaitForEncoderHEAD1(m_nEncoderSumCount, 1); 
//
//	pDsp->SetFlyXHEAD1(dScaleFactorX); 
//
//	UINT uListCheck = 0;
...
//	pDsp->nSetScannerParameter(RTC_CARD_NUM_1, HEAD1ScannerParameter.flagSpeed ,HEAD1ScannerParameter);
//	/////// ARC IN END
//	pDsp->N_Mark_Rel(RTC_CARD_NUM_1, -dTabAngleX ,dTabHeightField - (stPocketData.dArcInYPos * dFieldSize / dMmSize));
//
//
...
//
//	//nNexSumCount += HEAD1ScannerParameter.flagOffset; // 선단부 옵셋 Test
//
//	m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
//	pDsp->WaitForEncoderHEAD1(m_nEncoderSumCount, 1);
//
//	//nNexSumCount -= HEAD1ScannerParameter.flagOffset; // R값에 따른 선단부 옵셋 적용후 다시 빼줘야 전체길이가 맞을듯 하여
//
//	int nFlagCount = 0;
//
//	long nX, nY;
//
//	pDsp->GetEncodeHEAD1(nX, nY);
//	double dPreEnc = 0;
//	dPreEnc = nY / pFieldParameter->GetKX(); // 현재 엔코더값 -> 현재가 아닌 스톱 누르기 전 엔코더값이 필요
//
//	n_write_io_port_list(RTC_CARD_NUM_1, 69);
//
//	uFlagPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1); // 이어작업 시 여기서 시작해야함. ( 기존 엔코더값을 기준으로 + nGrowsLeng을 기준으로 )
//
//	n_write_io_port_list(RTC_CARD_NUM_1, 69);
//
//	pDsp->SetFlyYHEAD1(1.0); 
...
//	nNexSumCount = 0;
//
//	double dFirstNotchingWidth = stPocketData.dNotchingWidth1;
//
...
//
//		CString tmpData;
//		//GetDlgItemText(IDC_TEXT_NG_OFFSET, tmpData);
//		if(i == 9)
//		{
//			stPocketData.dNotchingWidth2 -= _ttof(tmpData);
//
//			//2025.02.15 jjsjong 더할 필요 없음.
//			//nNexSumCount += (stPocketData.dNotchingWidth3 - stPocketData.dArcOutXPos + dFirstNotchingWidth);
//			nNexSumCount += (stPocketData.dNotchingWidth3 - stPocketData.dArcOutXPos );
//
//			m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
//			pDsp->WaitForEncoderHEAD1(m_nEncoderSumCount, 1);
//			break;
...
//		else
//		{
//			nNexSumCount += (stPocketData.dNotchingWidth2 - stPocketData.dArcOutXPos);
//			if(i == 0) 
//			{
//				nNexSumCount += dEncoderOffset; // 첫노칭 컷팅길이가 길어지는 문제 보정용...????? 원인파악 필요.
//			}
//
//			m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
//			pDsp->WaitForEncoderHEAD1(m_nEncoderSumCount, 1);
...
//
//	}
//	// pDsp->N_Fly_Return(RTC_CARD_NUM_1, dStartCutPosX , dStartCutPosY, MM);
//
//#ifndef _SIMUL_
...
//	posX = pDsp->GetPosX();
//	posY = pDsp->GetPosY();
//	strLogData.Format("posX : %d, posY : %d", posX, posY);      
//	log->WriteString(strLogData);
...
//	if(ModeValue == _T("Anode_A") || ModeValue == _T("Anode_B"))
//	{
//		pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x401 , 0xFBFE); // 1번 및 10번 I/O 들어올때까지 대기
//		pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행
//		pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x01 , 0xFFFE); // 10번 I/O 꺼질 때까지 대기
//		pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행	
//	} 
//	else if(ModeValue == _T("Cathode_A") || ModeValue == _T("Cathode_B"))
//	{
//		pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x801, 0xF7FE); // 1번 및 11번 I/O 들어올때까지 대기
//		pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행
//		pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x01 , 0xFFFE); // 11번 I/O 꺼질 때까지 대기
//		pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행
//	}
//
//	//if (ModeValue == _T("Cathode_A") || ModeValue == _T("Cathode_B"))
//	{
...
//	///////////////////////////////////////////////////////////////////////////// LIST 1 END //////////////////////////////////////////////////////////////////////////////
//	double dReverseNotchingStartLength = 0.0;
//	dReverseNotchingStartLength = stPocketData.dNotchingWidth2;
//
//	///////////////////////////////////////////////////////////////////////////// LIST 2 START ////////////////////////////////////////////////////////////////////////////
//	pDsp->SetStartListHEAD1(2);
//
//	//pDsp->NOutputIOList(RTC_CARD_NUM_1, RTC_SIG_O_REMOTE_KEY_SWITCH, TRUE);
//
//	nNexSumCount = 0;
//
//	pDsp->nSetFrequency(RTC_CARD_NUM_1,HEAD1ScannerParameter.flagFreq, HEAD1ScannerParameter.pulsewidth );
...
//	//2025.01.31 jjsjong 스케일 통일
//	dNotchingKX = pFieldParameter->GetKX();
//	if(dNotchingKX < 0) 
//	{
//		dNotchingKX = -dNotchingKX;
//	}
...
//
//
//	// pDlg->SetTimer(TM_CHECK_POCKET_IO, 100, NULL);
//
//
//	dStartCutPosX = pFieldParameter->GetScannerStartPosX();
//	dStartCutPosY = pFieldParameter->GetScannerStartPosY();
...
//	pDsp->N_Jump_Abs(RTC_CARD_NUM_1, dStartCutPosX , dStartCutPosY, MM);
//	pDsp->N_Mark_Rel(RTC_CARD_NUM_1, 0, -(dTabHeightField + dStartExtLenField - (stPocketData.dArcOutXPos * dFieldSize / dMmSize)));
//	pDsp->N_Mark_Abs(RTC_CARD_NUM_1, dTabAngleX, 0);
//
//
//	pDsp->nSetFrequency(RTC_CARD_NUM_1,HEAD1ScannerParameter.nonflagFreq, HEAD1ScannerParameter.pulsewidth );
//	pDsp->nWriteDA1List(RTC_CARD_NUM_1,HEAD1ScannerParameter.nonflagPower);
...
//	pDsp->SetFlyXHEAD1(dScaleFactorX); 
//
//	for(int nGrowsLeng = 0; nGrowsLeng < 10; nGrowsLeng++)
//	{
//		if(nGrowsLeng > 0)
//		{
//			nNexSumCount += stPocketData.dArcInYPos;
//		}		
//
//		//pDsp->OutputIO(RTC_SIG_O_FIRST_TAB, TRUE);
//
//		/////// ARC IN START
//		pDsp->nSetScannerParameter(RTC_CARD_NUM_1, HEAD1ScannerParameter.markSpeed ,HEAD1ScannerParameter);
//		pDsp->nSetFrequency(RTC_CARD_NUM_1,HEAD1ScannerParameter.flagFreq , HEAD1ScannerParameter.pulsewidth );
...
//
//		CString tmpData;
//		//pDlg->GetDlgItemText(IDC_TEXT_NG_OFFSET, tmpData);
//		if(nGrowsLeng == 9)
//		{
//			nNexSumCount += (stPocketData.dNotchingWidth3 - stPocketData.dArcOutXPos);
//			m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
...
//		else
//		{
//			nNexSumCount += (dReverseNotchingStartLength - stPocketData.dArcOutXPos);
//			m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
//			pDsp->WaitForEncoderHEAD1(m_nEncoderSumCount, 1);
//
//			dReverseNotchingStartLength -= _ttof(tmpData);
//		}
//
//	}
//	pDsp->N_Fly_Return(RTC_CARD_NUM_1, dStartCutPosX , dStartCutPosY, MM);
//
//	//	pDsp->nListJumpPos(RTC_CARD_NUM_1, uSecondJumpPos); // 재 진입 없이 이어작업
//
//#ifndef _SIMUL_
//	n_store_encoder(RTC_CARD_NUM_1, 0);
//	n_store_encoder(RTC_CARD_NUM_1, 1);
...
//	else
//		nIOTestFor_ABTytpe = RTC_SIG_I_NOTCHING_SENSOR_B;
//
//
...
//		{
//			if(pDsp->nGetInputValue(RTC_CARD_NUM_1, nIOTestFor_ABTytpe) == TRUE /*|| pDsp->nGetInputValue(RTC_CARD_NUM_1, RTC_SIG_I_NOTCHING_SENSOR_B) == TRUE*/)
//			{
//				n_execute_list(RTC_CARD_NUM_1, 1); 
//				while(TRUE)
//				{
//					if(pDsp->nGetInputValue(RTC_CARD_NUM_1, nIOTestFor_ABTytpe) == FALSE /*&& pDsp->nGetInputValue(RTC_CARD_NUM_1, RTC_SIG_I_NOTCHING_SENSOR_B) == FALSE*/)
//						break;
//					Sleep(10);
//				}
//			}
...
//	dSecondEncResetPosWidth = stPocketData.dTotalWidth - (stPocketData.dNotchingWidth1 + stPocketData.dCuttingWidth);
//
//	double dEncoderPreValue;
//
//	double dRemainLength;
//
...
//	//		if(pDsp->nGetInputValue(RTC_CARD_NUM_1, nIOTestFor_ABTytpe) == TRUE /*|| pDsp->nGetInputValue(RTC_CARD_NUM_1, RTC_SIG_I_NOTCHING_SENSOR_B) == TRUE*/)
//	//		{
//	//			bRestartCheck_BEF = TRUE;
//	//			if(bRestartCheck != bRestartCheck_BEF)
//	//			{
//	//				log->WriteString("I/O 10 In");
//
//
//	//				// 센서길이까지 대기
//	//				// pDsp->GetEncodeHEAD1(nEncX, nEncY); 
//	//				// dEncoderPreValue = nEncY / -pFieldParameter->GetKY();
//	//				// dRemainLength = dSecondEncResetPosWidth - dEncoderPreValue; // 앞으로 가야할 거리
//
//	//				while(TRUE) 
//	//				{
//	//					pDsp->GetEncodeHEAD1(nEncX, nEncY);
//	//					dEncoderPreValue = nEncY / -pFieldParameter->GetKY(); // 현재 가공위치
//
//	//					if(dEncoderPreValue >= dSecondEncResetPosWidth - dEncoderOffset)
//	//					{ 
//	//						break;
//	//					}
//	//					Sleep(1);
...
//	//		else
//	//		{   
//	//			bRestartCheck_BEF = FALSE;
//	//			if(bRestartCheck != bRestartCheck_BEF)
//	//			{
//	//				log->WriteString("I/O 10 Out");
//	//			}
//	//		}
//	//		bRestartCheck = bRestartCheck_BEF;
//	//		//if(pDsp->nGetInputValue(RTC_CARD_NUM_1, 11) == TRUE)
//	//		Sleep(1);
//	//	}
//	//}
//
...
DWORD WINAPI CRunMgr::ExecutePatternSDI_Pouch_Head1(LPVOID lparam)
{
	...
	// pDlg->m_dPLCTotalWidth = stPocketData.dTotalWidth;
	...
	// LIST2
	UINT u2ndListJumpPos = 0;
	UINT u2ndListEndPos = 0;
	UINT u2ndListOncPattern = 0;
	// NG 태그 관련 Pos
	UINT u2ndListNGPos = 0;
	...
	double dNotchingWidth[25]; // 노칭길이 배열

	double dBefTotalWidth = 0; 
	double* pNotchingWidths = &stPocketData.dNotchingRealWidth1; // 구조체 첫 번째 주소 값

	double dTabCount = stPocketData.dTabCount;

	for (int i = 0; i < dTabCount; i++) 
	{
		dBefTotalWidth = 0;

		for (int j = 0; j < i; j++) 
		{
			dBefTotalWidth += dNotchingWidth[j] + stPocketData.dCuttingWidth;
		}
		dNotchingWidth[i] = pNotchingWidths[i] - dBefTotalWidth;
	}

	for( int i = dTabCount; i < 25; i++)
	{
		dNotchingWidth[i] = 0;
	}
	/////////////////////////////////////////////////////////////// LIST 1 START //////////////////////////////////////////////////////////////////
	...
	pDsp->nListJumpRel(RTC_CARD_NUM_1, 20); // 상대적으로 아래 n번째꺼 실행
	////////////////////////////////////////////// 2ndJumpPos Start ////////////////////////////////////////////////////////////
	n_write_io_port_list(RTC_CARD_NUM_1, 69); // 1
	u2ndJumpPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1);
	...
	pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x101, 0xFEE6);
	pDsp->nListJumpRel(RTC_CARD_NUM_1, -1);
	pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x01 , 0xFFE6);
	pDsp->nListJumpRel(RTC_CARD_NUM_1, -1);
	...
	double dTotalWidthOffset;
	dTotalWidthOffset = stPocketData.dTotalWidth - pDlg->m_PLCTotalLength;
	nNexSumCount += (dNotchingWidth[0] + dSensorLeng - stPocketData.dArcInYPos - dTotalWidthOffset);
// 	nNexSumCount += (dNotchingWidth[0] + dSensorLeng - stPocketData.dArcInYPos); // 추가로 1운전과 연속운전시 전체적으로 패턴이 밀리는 경향이 보인다고 함
	...
	//{
	//	pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x401 , 0xFBE6); // 1번 및 10번 I/O 들어올때까지 대기
	//	pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행
	...
	//{
	//	pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x801, 0xF7E6); // 1번 및 11번 I/O 들어올때까지 대기
	//	pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행
	...
	////pDsp->nListJumpRel(RTC_CARD_NUM_1, -1); // 상대적으로 아래 n번째꺼 실행
	//
	//pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x10 , 0xFFE6);
...
//	nNexSumCount = 0;
//	////////////////////////////////////////////// 2ndJumpPos End //////////////////////////////////////////////////////////////
//	nNexSumCount += (dNotchingWidth[0] + dSensorLeng - stPocketData.dArcInYPos); // 센서길이를 while문에서 기다렷다고 생각 // test
//
//	// 들어와서 레이저 안쏨
//	pDlg->m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
//	pDsp->WaitForEncoderHEAD1(pDlg->m_nEncoderSumCount, 1);
...
//	pDsp->nSetScannerParameter(RTC_CARD_NUM_1,HEAD1ScannerParameter.flagSpeed, HEAD1ScannerParameter);
//
//	nNexSumCount += stPocketData.dCuttingWidth + stPocketData.dNotchingAccWidth1;
//
//	pDlg->m_nEncoderSumCount = (int)mathUtil.Round(nNexSumCount * dNotchingKX, 0);
//	pDsp->WaitForEncoderHEAD1(pDlg->m_nEncoderSumCount, 1);
//
//	nFlagCount = stPocketData.dTabCount;
//
//	double* dAccOffset = &stPocketData.dNotchingAccWidth1;
//
//	// i를 이어작업 시 가변되도록 변경해야함
//	for(int i = 0; i < nFlagCount; i++)
//	{
...
//
//		pDsp->nSetScannerParameter(RTC_CARD_NUM_1,HEAD1ScannerParameter.flagSpeed, HEAD1ScannerParameter);
//		nNexSumCount += dAccOffset[i + 1]; // 1회 운전 가감속 옵셋
//		if(i == nFlagCount - 2)
//		{
//			nNexSumCount += stPocketData.dCuttingWidth + stPocketData.dArcInYPos + HEAD1ScannerParameter.dCuttingOffset;
//		}
...
//	pDsp->nIf_not_Cond(RTC_CARD_NUM_1,  0x10 , 0xFFE6);
//	n_list_jump_pos(RTC_CARD_NUM_1, u2ndJumpPos);
//	pDsp->nIf_Cond(RTC_CARD_NUM_1, 0x10 , 0xFFE6);
...
/////////////////////////////////////////////////////////////// LIST 2 START //////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////// 2ndJumpPos Start ////////////////////////////////////////////////////////////
	n_write_io_port_list(RTC_CARD_NUM_1, 69); // 1
	u2ndListJumpPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1);
	...
	n_store_encoder(RTC_CARD_NUM_1, 1);
#endif
	u2ndListEndPos = pDsp->nGetInputPointer(RTC_CARD_NUM_1);
	...
	/////////////////////////////////////////// 1회 운전 로직 ///////////////////////////////////////////////////
//	n_write_io_port_list(RTC_CARD_NUM_1, 69); // 1
//	u2ndListOncPattern = pDsp->nGetInputPointer(RTC_CARD_NUM_1);
//
//	pDsp->SetFlyYHEAD1(1.0); 
//	pDsp->SetFlyYHEAD1(0.0);
//	pDsp->SetFlyXHEAD1(1.0);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	while( pDlg->m_bThreadAlive )
	{
		...
		{
			if(pDlg->m_bListCheck == TRUE)
			{
				n_execute_list(RTC_CARD_NUM_1, 2);
				pDlg->m_bListCheck = FALSE;
			} else
			{
				n_execute_list_pos(RTC_CARD_NUM_1, 1, u2ndJumpPos);
				pDlg->m_bListCheck = TRUE;
			}
		}
		

		pDsp->nGetstatus(RTC_CARD_NUM_1, uBusy, uPos );
		if(uPos <= uEndPos && uPos > uJumpPos)
		{
			pMainFrm->SetDlgItemText(IDC_CTHEAD1_ENCPOS, _T("Skip"));
		} else
		{
			pMainFrm->SetDlgItemText(IDC_CTHEAD1_ENCPOS, _T("Once"));
		}
...
//		}
		...
		} else
		{
			...
			if(bNGCheck != bNGCheck_BEF)
			{
				//log->WriteString("[NG TEST] RTC_SIG_I_FIRST_TAB(NG Tag) I/O OUT");
			}
		}
...
DWORD WINAPI CRunMgr::ExecutePatternSDI_Head2(LPVOID lparam)
{
	...
	double nEncoderScaleY = 40.0;
	int nSpeedIndexTest = 0;
	double nNexSumCount = 0; //´ÙÀ½À§Ä¡ ¿£ÄÚ´õ
	double nStartPos = 0; // ¿£ÄÚ´õ ½ÃÀÛ Æ÷Áö¼Ç
	double dFlagEncSum = 0;
	...
	const double dAddAmount = 0;
	double dTempValue = 0;
	double dOverflowField = m_dMaxMM / 2 *  m_dMaxField / m_dMaxMM;  // 300mm ³Ñ¾î°¡¸é ¿À¹öÇÃ·Î¿ì
	double dFlagDistanceField = 0;
